...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Quiet Demo Installer\n"
      else:
        line="OutputBaseFilename=Quiet Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Quiet Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Quiet installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Quiet Demo installer\n"
     else:
       line="SetupWindowTitle=Quiet installer\n"
