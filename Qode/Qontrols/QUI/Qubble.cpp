...
Qubble::Qubble(const Qheme& _qheme)
  : IBubbleControl(IText(16.f, EAlign::Center, _qheme.foreGround), _qheme.foreGround.WithOpacity(.0f), _qheme.foreGround)
  , qheme(_qheme)
{
  mIgnoreMouse = true;
}
...
{
  mText = IText(16.f, EAlign::Center, qheme.foreGround);
